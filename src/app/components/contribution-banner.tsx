...
// Hoisted static data outside component
const features = [
    { icon: Building07, title: "Masjid", description: "A beautiful mosque for daily prayers and Friday gatherings" },
    { icon: BookOpen01, title: "Madrasa", description: "Islamic education center for children and adults" },
    { icon: Users01, title: "Community Hall", description: "Space for weddings, events and community gatherings" },
    { icon: Heart, title: "Welfare Programs", description: "Support for orphans, widows and families in need" },
    { icon: Star01, title: "Quran Classes", description: "Daily Quran recitation and memorization programs" },
    { icon: Building07, title: "Wudu Area", description: "Clean ablution facilities for men and women" },
    { icon: BookOpen01, title: "Library", description: "Islamic books and educational resources" },
    { icon: Users01, title: "Guest Rooms", description: "Accommodation for travelers and visitors" },
] as const;
...
export const ContributionBanner = ({ className }: { className?: string }) => (
    <div id="progress" className={cx("w-full relative overflow-hidden h-[900px] sm:h-[800px] scroll-mt-20", className)}>
