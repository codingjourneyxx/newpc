...
import { Heart, Phone, Copy01, Building07, CreditCard01, MessageCircle01, Star01, Users01, BookOpen01 } from "@untitledui/icons";
...
const impactStats = [
    { icon: Users01, value: "500+", label: "Worshippers" },
    { icon: BookOpen01, value: "200+", label: "Students" },
    { icon: Star01, value: "5", label: "Daily Prayers" },
] as const;
        ...
        <div className="mx-auto max-w-7xl border-l border-r border-secondary">
            <div className="relative px-4 py-12 sm:px-6 sm:py-16 md:py-24 lg:px-8  ">
                ...
                <div className="relative grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
                    {/* Left Column - Content */}
                    <div>
                        <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1.5 mb-6">
                            <Heart className="size-3.5 text-emerald-600" />
                            <span className="text-xs font-medium text-emerald-700">Sadaqah Jariyah</span>
                        </div>

                        <h2 className="max-w-lg font-serif text-3xl font-normal italic tracking-tight text-primary sm:text-4xl md:text-5xl">
                            Be part of this{" "}
                        ...
                        <p className="mt-6 max-w-md text-base leading-relaxed text-secondary sm:text-lg">
                            Your contribution helps build a place of worship and learning that will benefit generations to come. Every rupee counts.
                        </p>
                        ...
                        {/* Quote */}
                        <div className="mt-8 rounded-xl bg-emerald-50 p-4 border-l-4 border-emerald-500">
                            <p className="text-sm italic text-emerald-800">
                                "Whoever builds a mosque for Allah, Allah will build for him a house in Paradise."
                            </p>
                            <p className="mt-2 text-xs font-medium text-emerald-600">— Prophet Muhammad ﷺ</p>
                        </div>
                    </div>

                    {/* Right Column - Donation Card (unchanged) */}
                    <div className="relative">
                        <div className="rounded-xs border border-white bg-primary p-4 shadow-2xl sm:p-6">
